...
echo "<h3>Program Studi :".$_POST['prodi']."</h3>"; //tampilkan teks Tempat dan Tanggal Lahir dan mengambil nilai dari method post input type ttl
echo "<h3>NPM :".$_POST['npm']."</h3>"; //tampilkan teks pendidikan dan mengambil nilai dari method post input type pendidikan
